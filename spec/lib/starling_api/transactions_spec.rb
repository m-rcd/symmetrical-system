...
RSpec.describe StarlingApi::Transactions do
  subject { described_class.fetch(account_uid:, category_uid:) }
  ...
  let(:query) do 
    {
      minTransactionTimestamp:  DateTime.new(2023, 9, 0o3).beginning_of_week,
      maxTransactionTimestamp: DateTime.now.end_of_week
    }
  end
